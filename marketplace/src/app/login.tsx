...
const Login = () => {
  return (
    <div className="flex flex-col items-center justify-center">
      <div className="flex items-center justify-center rounded-full bg-gray-200 text-gray-400 text-7xl h-24 w-24 mb-4 ">
        <FaUser />
      </div>
      {/* user */}
        ...
        <div className="w-fir h-fit sm:w-fit sm:h-fit xs:w-fit xs:h-fit  md:w-fit md:h-fit lg:w-fit lg:h-fit xl:w-30rem xl:h-30rem  rounded-md shadow-2xl bg-slate-300 mb-4">
          ...
          <form className="flex flex-col px-6 py-10 gap-y-6 items-center justify-center">
            <div className="flex w-full sm:w-auto sm:h-auto xl:w-auto xl:h-auto md:w-auto md:h-auto ">
              ...
              <input
                className="h-10 w-40 bg-slate-100 sm:w-fit md:w-fit lg:w-fit xl:w-fit  flex-grow px-4 py-4 shadow-2xl rounded-md"
                type="text"
              />
            </div>
            ...
            <div className="flex w-full sm:w-auto sm:h-auto xl:w-auto xl:h-auto md:w-auto md:h-auto mt-4">
              ...
              <input
                className="h-10 bg-slate-100  w-40 sm:w-fit md:w-fit lg:w-fit xl:w-fit  flex-grow px-4 py-4  shadow-2xl rounded-md"
                type="text"
              />
            </div>
          </form>
