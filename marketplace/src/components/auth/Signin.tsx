      ...
      <div className="flex flex-col items-center justify-start w-20rem h-35rem bg-slate-300 sm:w-35rem sm:h-35rem xs:w-30rem xs:h-30rem md:w-45rem md:h-35rem lg:w-60rem lg:h-35rem xl:w-65rem xl:h-30rem rounded-md shadow-2xl">
        ...
        <div className="grid grid-rows-2 gap-6 px-4 my-8 w-full">
          ...
          <form className="flex flex-col gap-3">
            <div className="flex flex-col md:flex-row md:items-center">
              <div className="flex flex-col w-full md:w-1/2">
                <label htmlFor="firstName" className="mb-1 font-exo text-2xl">
                  First Name
                </label>
                <input
                  placeholder="Piyush"
              ...
              <div className="md:w-6"></div> {/* Space or gap */}
              <div className="flex flex-col w-full md:w-1/2">
                <label htmlFor="lastName" className="mb-1 font-exo text-2xl">
                  Last Name
                </label>
                <input
                  placeholder="Kashyap"
          ...
          <form className="flex flex-col gap-3">
            <div className="flex flex-col md:flex-row md:items-center">
              <div className="flex flex-col w-full md:w-1/2">
                <label htmlFor="email" className="mb-1 font-exo text-2xl">
                  E-Mail
                </label>
                <input
              ...
              <div className="md:w-6"></div> {/* Space or gap */}
              <div className="flex flex-col w-full md:w-1/2">
                <label htmlFor="password" className="mb-1 font-exo text-2xl">
                  Password
                </label>
                <input
        ...
        <button className="w-6 h-6 bg-slate-700">Confirm</button>
        <button className="w-6 h-6 bg-slate-700">Cancel</button>
        </div>
      </div>
    </div>
  );
